 ...
 *
 */
public class SmallNewsReaderApplication extends SmallRssReaderApplication
{
	...
	{
		return R.layout.smallapp_news_listview_minimized;
	}
	...
	{
		return R.string.app_newsmatome_name;
	}
	
	protected int getSelectedViewUrlKeyStringId()
	{
		return R.string._newsmatome_select_viewurl_key;
	}
	
	protected int getViewUrlValueArrayId()
	{
		return R.array._newsmatome_viewurl_value_list;
	}
	...
	{
		return "findNewsDateIndex";
	}
	
	protected String getFindSortIndexPrefKey()
	{
		return "findNewsSortIndex";
	}
